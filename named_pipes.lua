...
local pGetModuleHandle_sig = Utils.FindSignature("engine.dll", "\xFF\x15\xCC\xCC\xCC\xCC\x85\xC0\x74\x0B") or error("Couldn't find signature #1")
local pGetProcAddress_sig = Utils.FindSignature("engine.dll", "\xFF\x15\xCC\xCC\xCC\xCC\xA3\xCC\xCC\xCC\xCC\xEB\x05") or error("Couldn't find signature #2")

local jmp_ecx = Utils.FindSignature("engine.dll", "\xFF\xE1")
